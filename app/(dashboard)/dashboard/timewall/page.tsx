...
export default async function TimeWallPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto h-full flex flex-col">
      ...
      {/* Embedded Iframe */}
      <div className="premium-card p-1 rounded-3xl border border-border/50 bg-gradient-to-br from-card/90 via-card/75 to-card/50 shadow-2xl relative overflow-hidden flex-1 min-h-[750px]">
        <iframe
          src={timeWallUrl}
          className="w-full h-[750px] sm:h-[800px] rounded-2xl border-none bg-black/20"
