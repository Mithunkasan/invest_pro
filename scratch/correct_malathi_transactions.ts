...
async function run() {
  ...
  const referrerL2Id = 'cmqwki9k40000jy04h8gf9j5q' // Vinish MVV (User ID, NOT Admin ID)
  ...
  console.log('--- EXECUTING CORRECTION TRANSACTION ---')

  await prisma.$transaction(async (tx) => {
    // 1. Update A. Malathi's transactions
    ...
    console.log(`Updated transaction ${tx1Id} (Points: 11759) amount to ${tx1CorrectAmount}`)
    ...
    console.log(`Updated transaction ${tx2Id} (Points: 20187) amount to ${tx2CorrectAmount}`)

    // 2. Update A. Malathi's wallet
    ...
    // 3. Referrer Level 1 (Veerasundari M): commission 10%
    ...
    // 4. Referrer Level 2 (Vinish MVV): commission 5%
