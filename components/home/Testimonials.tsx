...
const testimonials = [
  {
    ...
    text: 'InvestPro has completely changed how I manage my passive income. The daily ROI is consistent and the instant withdrawals are a lifesaver.',
    avatar: 'RK',
    rating: 5
  },
  {
    ...
    <section className="section-container bg-muted/30">
      <div className="text-center mb-16">
        ...
        <p className="section-subheading">
          Join over 25,000 satisfied investors who are growing their wealth with InvestPro.
        </p>
      </div>
