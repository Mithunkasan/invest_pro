    ...
    <div className="space-y-6">
      ...
      <div className="premium-card p-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-2 pt-2">
          <a href={`https://wa.me/?text=${encodeURIComponent('Join VR Galaxy Networks and explore digital earning opportunities! ' + referralLink)}`} target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-xl bg-green-500/10 text-green-500 border border-green-500/20 text-sm hover:bg-green-500/20 transition-colors">
            📱 Share on WhatsApp
          </a>
